getfenv().hbe = true
    ...
    table.insert(, HideTarget.OnClientEvent:Connect(function()
        Target = nil;
    ...
    table.insert(, UpdateTarget.OnClientEvent:Connect(function(T)
        Target = T;
    ...
    Settings.HITBOX.Size = Vector3.new(0,0,0);
    Settings.HITBOX.Transparency = 1;
    Settings.TARGETHITBOX.Size = Vector3.new(0,0,0);
    Settings.TARGETHITBOX.Transparency = 1;
